        ...
        <div className="auth-card">
          ...
          {showForgot ? (
            <>
              ...
              {forgotError && <div className="alert alert-error">⚠️ {forgotError}</div>}
              {forgotMsg && <div className="alert alert-success" style={{ color: "#4caf50", border: "1px solid #4caf50", padding: "12px", borderRadius: "8px", margin: "10px 0" }}>{forgotMsg}</div>}
