...
export default function Login() {
  ...
  const handleSocialMock = (provider) => {
    alert(`OAuth integration for ${provider} coming soon!`);
  };
      ...
      <div className="auth-form-side">
        <div className="auth-card">
          ...
          <div className="social-logins">
            <button type="button" className="btn-social" onClick={() => window.location.href = "http://127.0.0.1:8000/auth/google/login"}>
            ...
            <button type="button" className="btn-social" onClick={() => window.location.href = "http://127.0.0.1:8000/auth/github/login"}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <div className="label-row">
                ...
                <a href="#" className="forgot-link" onClick={(e) => { e.preventDefault(); alert('Reset password coming soon!'); }}>Forgot password?</a>
              </div>
              <div className="input-with-icon">
