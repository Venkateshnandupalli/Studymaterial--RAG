      ...
      <div className="auth-form-side">
        <div className="auth-card">
          ...
          <div className="social-logins">
            <button type="button" className="btn-social" onClick={() => window.location.href = `${BASE_URL}/auth/google/login`}>
            ...
            <button type="button" className="btn-social" onClick={() => window.location.href = `${BASE_URL}/auth/github/login`}>
